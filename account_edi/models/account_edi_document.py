...
from odoo.addons.account_edi_extended.models.account_edi_document import (
...
class AccountEdiDocument(models.Model):
    ...
    def write(self, vals):
        ...
        if (
            "blocking_level" in vals
            and "blocking_level" not in self.env["account.edi.document"]._fields
        ):
    ...
    def _convert_to_old_jobs_format(self, jobs):
        ...
        return [
            (
                (
                    documents.edi_format_id,
                    documents[0].state,
                    doc_type,
                    documents.move_id.company_id,
                ),
                documents,
            )
