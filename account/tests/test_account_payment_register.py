...
class TestAccountPaymentRegister(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        ].payment_debit_account_id.copy()
        cls.payment_credit_account_id = cls.company_data[
            "default_journal_bank"
        ].payment_credit_account_id.copy()

        cls.custom_payment_method_in = (
        ...
        cls.manual_payment_method_in = cls.env.ref(
            "account.account_payment_method_manual_in"
        )

        cls.custom_payment_method_out = (
            cls.env["account.payment.method"]
            .sudo()
            .create(
                {
        ...
        cls.manual_payment_method_out = cls.env.ref(
    ...
    def test_payment_method_different_type_single_batch_not_grouped(self):
        ...
        for moves in ((invoice_1 + invoice_2), (refund_1 + refund_2)):
            ...
            expected_available_payment_methods = (
                wizard.journal_id.inbound_payment_method_ids
                if moves[0].move_type == "in_refund"
                else wizard.journal_id.outbound_payment_method_ids
            )
        ...
        self.assertRecordValues(
            ...
            [
                {
                    "ref": "BILL/2017/01/0001",
                    "payment_method_id": self.bank_journal_1.outbound_payment_method_ids[
                        0
                    ].id,
                    "payment_type": "outbound",
                }
            ...
            [
                {
                    ...
                    "payment_method_id": self.bank_journal_1.inbound_payment_method_ids[
                        0
                    ].id,
                    "payment_type": "inbound",
                },
