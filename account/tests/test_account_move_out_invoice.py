...
class TestAccountMoveOutInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    def test_out_invoice_multi_date_change_period_accrual(self):
        ...
        for date, move, ref in zip(
            dates, moves, ["INV/2017/01/0001", "INV/2017/01/0002", "INV/2017/02/0001"]
        ):
            self.assertInvoiceValues(
                move,
                [
    ...
    def test_select_specific_product_account(self):
        ...
        self.assertRecordValues(
            invoice.invoice_line_ids, [{"account_id": other_income_account.id}]
        )
    ...
    def test_caba_with_different_lock_dates(self):
        ...
        if not self.env.user.user_has_groups("account.group_account_manager"):
            self.env.user.groups_id = [
                (4, [self.env.ref("account.group_account_manager").id], 0)
            ]
    ...
    def test_post_valid_invoices_when_auto_post(self):
        ...
        self.assertEqual(
            invalid_invoice_1.message_ids[0].body,
        ...
        self.assertEqual(
            invalid_invoice_2.message_ids[0].body,
