...
class TestAccountPayment(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.payment_debit_account_id = cls.copy_account(
            cls.company_data["default_journal_bank"].payment_debit_account_id
        )
        cls.payment_credit_account_id = cls.copy_account(
            cls.company_data["default_journal_bank"].payment_credit_account_id
        )
        ...
        cls.bank_journal_1.write(
            {
                ...
                "inbound_payment_method_ids": [
                    (6, 0, cls.env.ref("account.account_payment_method_manual_in").ids)
                ],
                "outbound_payment_method_ids": [
                    (6, 0, cls.env.ref("account.account_payment_method_manual_out").ids)
                ],
            }
        )
    ...
    def test_internal_transfer_change_journal(self):
        ...
        payment.write({"journal_id": self.company_data["default_journal_cash"].id})
