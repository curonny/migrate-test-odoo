...
class AccountPartialReconcile(models.Model):
        ...
        return {
            ...
            "tax_tag_ids": [
                (
                    6,
                    0,
                    base_line._convert_tags_for_cash_basis(base_line.tax_tag_ids).ids,
                )
            ],
            "tax_exigible": True,
        }
    ...
    def _prepare_cash_basis_tax_line_vals(self, tax_line, balance, amount_currency):
        ...
        return {
            ...
            "tax_tag_ids": [
                (6, 0, tax_line._convert_tags_for_cash_basis(tax_line.tax_tag_ids).ids)
            ],
    ...
    @api.model
    def _fix_cash_basis_full_balance_coverage(
        self,
        move_values,
        partial_values,
