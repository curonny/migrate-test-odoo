...
class AccountReconcileModel(models.Model):
    ...
    def _prepare_reconciliation(self, st_line, aml_ids=[], partner=None):
        ...
        foreign_currency = (
            st_line.foreign_currency_id or journal.currency_id or company_currency
        )
        ...
        if st_line.to_check:
            ...
            st_line_residual_currency = st_line._prepare_move_line_default_vals()[1][
                "amount_currency"
            ]
    ...
    def _get_partner_from_mapping(self, st_line):
        ...
        for partner_mapping in self.partner_mapping_line_ids:
            ...
            match_narration = (
                re.match(partner_mapping.narration_regex, st_line.narration or "")
